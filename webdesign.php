                    ...
                    <div   class="row justify-content-between align-items-center">
                        ...
                        <div class="d-none d-xs-none d-lg-block d-md-block d-sm-none col-xl-3 col-auto">
                            <div class="header-right">
                                ...
                                <a href="" style="margin-right:40px;color:white;font-weight:250"><span class="menu-text">Sign in</span></a>
        ...
        <section  style="margin-top:98px"> 
            ...
            <div class="page-title">
                <div class="container">
                    ...
                    <h1 class="title" style="color:white;font-size:30px">Website Design & Development</h1>
                </div>
            </div>
                            ...
                            <div class="tab-content">
                                <div id="overview" class="tab-pane fade show active">
                                    <div class="course-overview">
                                        ...
                                        <p style="color:white">You can launch a new career in web development today by learning Website Design. You don't need a computer science degree or expensive software. All you need is a computer, a bit of time, a lot of determination.</p>

                                        <p style="color:white">Let us make a professional website designer out of you and help you build a fantastic career in tech.</p>
                                        ...
                                        <p style="color:white">In this 10-week course, you will master the following:
                                        </p>

                                        <ul style="color:white">
                                        <img src="polygon 14.png" alt="" style="padding-right:4px">  Create any website of your choice <br>
                                        <img src="polygon 14.png" alt="" style="padding-right:4px">Design and prototype websites through UI skill <br>
                                        <img src="polygon 14.png" alt=""style="padding-right:4px">Style and beautify your website with CSS3 and Bootstrap <br>
                                        <img src="polygon 14.png" alt="" style="padding-right:4px"> Build mobile responsive websites that work on any device <br>
                                        <img src="polygon 14.png" alt=""style="padding-right:4px">Create websites for live customers, earn income and build your portfolio <br>
                                        <img src="polygon 14.png" alt=""style="padding-right:4px">Learn how to make and close deals, deliver projects and build a career
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Introduction (Week 1)</h5>
                                                        <p class="section-desc">A brief intro to website design</p>
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Creating websites that inspire</span>
                                                            <div class="course-item-meta">
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">UI / UX (Week 1 & 2)</h5>
                                                        
                                                        <p class="section-desc">Understand the basic principles of design to create beautiful websites. Here you will:</p>
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Understand User Interface & Uer Experience and Why they matter</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Learn UI Design With Figma</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Master Important Design Principles</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Learn Color & Contrast To Beautify Your Website</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Putting them all together (Design A Website Prototype)</span>
                                                            <div class="course-item-meta">
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Front-End Development (Weeks 3, 4 & 5)</h5>
                                                        <p class="section-desc">Learn the tools and skills to build</p>
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Master HTML & CSS3 (and build your first website)</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Bootstrap for Elegance</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Javascript for Functionality</span>
                                                            <div class="course-item-meta">
                                                        ...
                                                        <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">JQuery & AJAX</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Create a Fully Functional Business Website (project)</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Build an E-commerce Website (project)</span>
                                                            <div class="course-item-meta">
        ...
        <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Back-End Development (Weeks 6 & 7)</h5>
                                                        <p class="section-desc">Learn the tools and skills to build backend projects</p>
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">PHP / MYSQL (to create and manage backend applications)</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Learn to Create and deploy APIs</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Database Management </span>
                                                            <div class="course-item-meta">
                                                                                        ...
                                                                                        <li class="single-curriculum-section">
                                                                                            <div class="section-header">
                                                                                                <div class="section-left">
                                                                                                    ...
                                                                                                    <h5 class="title">Take Your Website Live (Week 8)</h5>
                                                                                                    <p class="section-desc">Find out how to launch a website and make it available to the public</p>
                                                                                            ...
                                                                                            <ul class="section-content">
                                                                                                ...
                                                                                                <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">Website Hosting & Domain</span>
                                                                                                        <div class="course-item-meta">
                                                                                                ...
                                                                                                <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">SSL Setup</span>
                                                                                                        <div class="course-item-meta">
                                                                                                ...
                                                                                                <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">Website Migration & Basic DevOps</span>
                                                                                                        <div class="course-item-meta">
                                                                                        ...
                                                                                        <li class="single-curriculum-section">
                                                                                            <div class="section-header">
                                                                                                <div class="section-left">
                                                                                                    ...
                                                                                                    <h5 class="title">Project Series (Weeks 9 & 10)</h5>
                                                                                                    <p class="section-desc">Series of real-life projects that will sharpen your skill in design as well as business application. </p>
                                                                                            ...
                                                                                            <ul class="section-content">
                                                                                                ...
                                                                                                <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">Creating a proposal & getting a deal (project)</span>
                                                                                                        <div class="course-item-meta">
                                                                                                ...
                                                                                                <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">Design & Prototyping (project)</span>
                                                                                                        <div class="course-item-meta">
                                                                                                ...
                                                                                                <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">Project Management & Delivery</span>
                                                                                                        <div class="course-item-meta">
...
<!--
                    ...
                    <div class="col-lg-5 col-12 order-lg-2 max-mb-50"  id="">
                          <img src="Rectangle 4.png" alt=""style="margin-top:95px">
     ...
     <form action="" method="post">
          <div class="row align-items-center justify-content-center">
               <div class="col-12 mt-4" >
                   ...
                   <input class="mt-4" type="email"name="location" placeholder="Location(State & Area)" required style="background-color:#1C1F2C ;height:70px;border:none"> 

                   <input class="mt-4" type="tel"name="name" placeholder="Phone/WhatsApp number" required style="background-color:#1C1F2C;height:70px;border:none"> 
               </div>
