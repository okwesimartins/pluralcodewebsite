...
<body>
   ...
   <div   class="header-section header-fluid fixed-top section">
        ...
        <main class="contact-information-section d-none d-lg-block d-xl-block d-md-none d-sm-none d-xs-none" style="height:740px;background: linear-gradient(90deg, #3F64F7 -18.69%, #5319B2 44.86%, #4940D6 112.15%);">
            <div class="container">
                <div class="row margin-bottom-85">
                    <div class="col-12">
                        <div class="contact-title max-width-740">
                            <h2 class="title" style="color:white;margin-top:100px">We're always ready to help you out, get in touch with us!</h2>
                        </div>
                    </div>
                </div>
                <div class="row row-30 row-cols-lg-3 row-cols-md-2 row-cols-1 max-mb-n30">
                    <div class="col max-mb-30">
                        ...
                        <div class="contact-info">
                            <div class="icon">
                                <i class="fal fa-map-marker-alt" style="color:#FFB341"></i>
                            </div>
                            <div class="info">
                                <h4 class="title" style="color:white"> Address</h4>
                                <span class="info-text" style="color:white"> 4b Toyin Street Ikeja, Lagos State</span>
                            </div>
                        </div>
                    ...
                    <div class="col max-mb-30">
                        ...
                        <div class="contact-info">
                            <div class="icon">
                                <i class="fal fa-phone" style="color:#FFB341"></i>
                            </div>
                            <div class="info">
                                <h4 class="title" style="color:white"> Contact</h4>
                                <span class="info-text" style="color:white"> Mobile: <strong style="color:white">+(234) 803-796-1731</strong>

                                    <br>
                                    Mail: <a href="mailto:support@pluralcode.academy" style="color:white">support@pluralcode.academy</a>
                                </span>
                            </div>
                        </div>
                        <!-- Single Contact Info End -->
                    ...
                    <div class="col max-mb-30">
                        ...
                        <div class="contact-info">
                            <div class="icon">
                                <i class="fal fa-clock" style="color:#FFB341"></i>
                            </div>
                            <div class="info">
                                <h4 class="title" style="color:white"> Hours of operation</h4>
                                <span class="info-text"style="color:white"> Monday – Friday : 09:00am – 05:00pm <br> Saturdays: 10:00am – 04:00pm</span>
                            </div>
                        </div>
                        <!-- Single Contact Info End -->
                    </div>
        ...
        <main class="contact-information-section d-lg-none d-xl-none d-md-block d-sm-block d-xs-block" style="width:100%;height:700px;background: linear-gradient(90deg, #3F64F7 -18.69%, #5319B2 44.86%, #4940D6 112.15%);">
            <div class="container">
                <div class="row margin-bottom-85">
                    <div class="col-12">
                        <div class="contact-title max-width-740">
                        ...
                        <nav class="site-mobile-menu" >
                            <ul>
                              ...
                              <li class="has-children">
                                  ...
                                  <span class="menu-toggle"><i class="far fa-angle-down"></i></span>
                                  <ul class="sub-menu">
                                      <li><a href="webdesign.php"><span class="menu-text">Website Design</span></a></li>
