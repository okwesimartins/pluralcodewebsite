...
<body style="background-color: #1C1F2C">
                                ...
                                <li class="has-children" >
                                    ...
                                    <li class="has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="digitalmarketing.php"><span class="menu-text">Mobile Appdevelopment</span></a></li>
                                             <li><a href="uiux.php"><span class="menu-text">Custom Service</span></a></li>
                                             <li><a href="uiux.php"><span class="menu-text">Product Design</span></a></li>
                                    ...
                                    <li class="">
                                        <a href="contact.php" style="color:white;font-weight:250"><span class="menu-text">Contact Us</span></a>
        ...
        <section  style="margin-top:98px"> 
            ...
            <div class="page-title">
                <div class="container">
                    ...
                    <h1 class="title" style="color:white;font-size:30px">Data Science</h1>
                </div>
            </div>
 ...
 <?php if(isset($message)):  ?>
     ...
     <form action="" method="post">
          <div class="row align-items-center justify-content-center">
               <div class="col-lg-5" >
                   <input type="text"name="name" placeholder="Name" style="background-color: #0A0F23; margin-left:30px;height:70px;border:none"> 
                   <input class="mt-4" type="email"name="email" placeholder="Email" style="background-color: #0A0F23;margin-left:30px;height:70px;border:none"> 
                   <input class="mt-4" type="text"name="location" placeholder="Location(State & Area)" style="background-color: #0A0F23;margin-left:30px;height:70px;border:none"> 

                   <input class="mt-4" type="tel"name="phone" placeholder="Phone/WhatsApp number" style="background-color: #0A0F23;margin-left:30px;height:70px;border:none"> 
               </div>
               <div style="width:15px;">

               </div>
               <div class="col-lg-5" style="">
                   <div  style="background-color: #0A0F23;border-radius:7px;width:570px;height:360px">
     ...
     <form action="" method="post">
          <div class="row align-items-center justify-content-center">
               <div class="col-12 mt-4" >
                   ...
                   <input class="mt-4" type="email"name="location" placeholder="Location(State & Area)" required style="background-color: #0A0F23;height:70px;border:none"> 

                   <input class="mt-4" type="tel"name="name" placeholder="Phone/WhatsApp number" required style="background-color: #0A0F23;height:70px;border:none"> 
               </div>
