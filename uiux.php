    ...
    <div id="page" class="section" >
        ...
        <section  style="margin-top:98px"> 
            ...
            <div class="page-title">
                <div class="container">
                    ...
                    <h1 class="title" style="color:white;font-size:30px">Product Design(UI/UX)</h1>
                </div>
            </div>
                            ...
                            <div class="tab-content">
                                <div id="overview" class="tab-pane fade show active">
                                    <div class="course-overview">
                                        ...
                                        <p style="color:white">You can launch a new career in product design today by learning UI/UX Design. You don't need a certificate in from a university or an institution. All you need is a computer, a bit of time, a lot of determination.</p>

                                        <p style="color:white">Let us make a professional product designer out of you and help you build a fantastic career in tech.</p>

                                        

                                        <p style="color:white">In this 4-week course, you will master the following:
                                        </p>
                                        ...
                                        <img src="polygon 14.png" alt="" style="padding-right:4px"> Learn how to build website UI <br>
                                        <img src="polygon 14.png" alt="" style="padding-right:4px">Prototype advance app UI<br>
                                        <img src="polygon 14.png" alt=""style="padding-right:4px">Learn how to build advance app UI <br>
                                        <img src="polygon 14.png" alt="" style="padding-right:4px"> Learn how to make and close deals, deliver projects and build a career<br>
                                        ...
                                        <ul class="curriculum-sections">
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <p class="section-desc">A brief intro to product design</p>
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Intro to UI/UX design & tools</span>
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Understanding how tool work</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Layers, Assets,Page & Design</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Move, Frame,Slice,Shapes,Pen & Pencil</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Text & Effect </span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Pan &  Comment</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Color Theory & style</span>
                                                            <div class="course-item-meta">
                                            ...
                                            <li class="single-curriculum-section">
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Applying design principle</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Contrast,Hierarchy,Focal Point, Alignment & Balance</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Group v Component</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Masking</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Layer Blending mode</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Constraint V Auto Layout,Inspect & Export</span>
                                                            <div class="course-item-meta">
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Weeks 3</h5>
                                                        <p class="section-desc">Keyboard Shortcuts,Layout Grid, Wireframe</p>
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Building Basic App Ui, Prototype,</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Building basic Website UI</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Prototype Advance Web UI</span>
                                                            <div class="course-item-meta">
        ...
        <li class="single-curriculum-section">
                                                ...
                                                <ul class="section-content">
                                                    ...
                                                    <li class="course-item">
                                                        <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                            <span class="item-name">Starting a career in UI design</span>
                                                            <div class="course-item-meta">
                                                    ...
                                                    <li class="course-item">
                                                                                                    <a class="section-item-link lesson" href="JavaScript:Void(0);">
                                                                                                        <span class="item-name">Creating a proposal </span>
                                                                                                        <div class="course-item-meta">
...
<!--
                    ...
                    <div class="col-lg-5 col-12 order-lg-2 max-mb-50"  id="">
                          <img src="Rectangle 13.png" alt=""style="margin-top:95px">
...
<section class=" d-lg-none d-sm-block d-md-block d-xs-block d-xl-none ">
    <div class="container">
                <div class="row " style="height:300px">
                      ...
                      <h1 class="title" style="color:white;font-size:30px;text-align:center;margin-top:26px">Product Design</h1>
                <h5 style="color:white;text-align:center;font-weight:200">Register and book a seat on our Product Design Masterclass. 
     ...
     <form action="" method="post">
          <div class="row align-items-center justify-content-center">
               <div class="col-lg-5" >
                   ...
                   <input class="mt-4" type="email"name="location" placeholder="Location(State & Area)" style="background-color: #1C1F2C ;margin-left:30px;height:70px;border:none"> 

                   <input class="mt-4" type="tel"name="name" placeholder="Phone/WhatsApp number" style="background-color: #1C1F2C ;margin-left:30px;height:70px;border:none"> 
               </div>
