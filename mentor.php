...
.mobilebg{
    background-image: url('partbana.png');
    background-repeat: no-repeat;
    background-size: cover;
}
.martins4{
    background-image: url('herobgm.png');
    background-repeat: no-repeat;
    background-size: cover;
}
</style>
                ...
                <div    class="container position-relative">
                    <div   class="row justify-content-between align-items-center">
                        ...
                        <div class="col d-none d-xl-block position-static">
                            <nav   class="site-main-menu" style="margin-right:10px">
                                <ul>
        ...
        <!-- Header Section End -->
         ...
         <section class="d-none d-xs-none d-lg-block d-md-block d-sm-none martins" data-aos="fade-up"  >
              ...
              <div class="container-fluid"  >
                    ...
                    <div class="col "   >
                             <h5  style="margin-top:85px;color:white;margin-left:50px;font-family: 'Nunito Sans', sans-serif;">Ready to earn a living while mentoring <br> brilliant minds?</h5> <br><h1 style="color:white;font-family: 'Nunito Sans', sans-serif;font-size:64px;font-weight:800;margin-left:50px">Partner With Us!</h1>

                              <p style="color:white;margin-left:50px">At PluralCode Academy, our mentors are essentially <br>  partners who work with us to bring out the best in <br> potential tech talents and as well facilitate projects, <br> bootcamps and fun events for the students.</p>
                              <a style="width:30%;margin-left:50px" class="btn btn-warning">Apply Now</a>
...
<section class=" d-xs-block d-lg-none d-md-none d-sm-block martins4" data-aos="fade-up"  >
        
        <div class="container-fluid"  >
       
              <div class="row align-items-center justify-content-center " >

              <div class="col-xs-12 mobilebg" style="width:100%;height:725px;margin-top:17%">
                       <h5  style="margin-top:85px;color:white;margin-left:9px;font-family: 'Nunito Sans', sans-serif;">Ready to earn a living while mentoring <br> brilliant minds?</h5> <br><h1 style="color:white;font-family: 'Nunito Sans', sans-serif;font-size:40px;font-weight:800;margin-left:9px">Partner With Us!</h1>

                        <p style="color:white;margin-left:9px">At PluralCode Academy, our mentors are essentially <br>  partners who work with us to bring out the best in <br> potential tech talents and as well facilitate projects, <br> bootcamps and fun events for the students.</p>
                        <p style="color:white;margin-left:9px">Mentors can earn up to N300,000 from 
each  <br> cohort and have fun while doing so.</p>
                        <a style="width:30%;margin-left:9px" class="btn btn-warning">Apply Now</a>
...
-->
        ...
        <section class="d-none d-sm-none d-lg-block d-md-none d-xs-none d-xl-block mt-4 pb-4">
    <div class="container">
                <div class="row">
                    <div class="col">
                    <img src="mentorbana.png" alt="">
                    </div>
...
<section class=" d-lg-none d-sm-block d-md-block d-xs-block d-xl-none mt-4">
    <div class="container">
                <div class="row " style="height:300px">
                      <div class="col-12 martins3" style="border-radius: 0px 26px 26px 0px;">
                      <h1 class="title" style="color:white;font-size:30px;text-align:center;margin-top:26px">Become a mentor</h1>
                <h5 style="color:white;text-align:center;font-weight:200">Join our sand box were we will be teaching you cutting edge 
technologies in various fields of tech such as web development, IOT, Data science and more 
</h5>
                      </div>
                </div>
    </div>
